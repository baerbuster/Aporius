...
// battery (reflect-haiku.mjs, battery2-7). Battery 7 is burned: four of its
// sentences were promoted into the prompt.
//
// Weighted toward we/us, which is now the most persistent failure class.
//
// Run: NODE_TLS_REJECT_UNAUTHORIZED=0 ANTHROPIC_API_KEY=<key> node reflection-bias-test/battery8.mjs
