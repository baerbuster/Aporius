...
// battery (reflect-haiku.mjs, battery2, battery3, battery4). Battery 4 is burned:
// seven of its sentences were promoted into the prompt.
//
// Run: NODE_TLS_REJECT_UNAUTHORIZED=0 ANTHROPIC_API_KEY=<key> node reflection-bias-test/battery5.mjs
