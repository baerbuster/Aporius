...
// battery (reflect_haiku.mjs, battery2-5). Battery 5 is burned: six of its
// sentences were promoted into the prompt.
//
// Keeps 4 no-person aphorisms to check the empty-string rule rewrite.
//
// Run: NODE_TLS_REJECT_UNAUTHORIZED=0 ANTHROPIC_API_KEY=<key> node reflection_bias_test/battery6.mjs
